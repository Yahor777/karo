...
const shots = [
  ["standard-workbench.png", '[data-shot="workbench"]'],
  ["standard-agent-run.png", '[data-shot="agent-run"]'],
  ["standard-plan-mode.png", '[data-shot="plan-mode"]'],
  ["standard-recovery-terminal.png", '[data-shot="recovery-terminal"]'],
  ["standard-compact.png", '[data-shot="compact"]'],
];
